...
// while(gamecount !== 0){
// while( checkWin1(ourboard) === 0 && !tie(ourboard)){
//     let [row,col] = monteCarlo(ourboard, player);
//     console.log("=== porposed move ====", row, col);
//     ourboard = makeMove(ourboard, col, player);
//     console.log("==================================");
//     console.log("col: "+col+" row: "+row);
//     console.log("player: "+player);
//     console.log("board: \n "+renderBoard(ourboard));
//     console.log("==================================");
//     player = 3 - player;
// }

// gamecount--;
// console.log("winner: "+checkWin1(ourboard));

// wins[checkWin1(ourboard)]++;
// ourboard = copyBoard(board);
// }
